    ...
    menuItems: [
...

      {
        ...
        children: [
          ...
          { label: "Requisições em Aberto", route: "/portaldorenderizador/atividades/em-aberto" },
        ],
      },
      ...
      */
     
      {
        ...
        label: "Equipe",
        route: "/portaldorenderizador/equipe"
      },
      {
        icon: (
          <svg
        ...
        label: "Portifólio",
        route: "/portaldorenderizador/portifolio"
      },
    ],
  },
  {
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/portaldorenderizador">
            <Image
              width={176}
              height={32}
